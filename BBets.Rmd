...
```{r}
EV= (.815)*1*26 - (1-.815)*1*26
print(EV)
```

Dr J. on average wins $16.38 playing BBets. 
...
for a fair bet Dr.J should be paying $4.40.
...
cat("Average win = ", EV)
```
For a class size of 27 people with 20 people betting, Dr.J's profit would be $5.18.

For a class size of 23 $1 dollar would be fair. 
